...
# Plot 1
plot(dt[, dateTime], powerDT[, Global_active_power], type="l", xlab="", ylab="Global Active Power")

# Plot 2
plot(dt[, dateTime],powerDT[, Voltage], type="l", xlab="datetime", ylab="Voltage")

# Plot 3
plot(dt[, dateTime], powerDT[, Sub_metering_1], type="l", xlab="", ylab="Energy sub metering")
lines(dt[, dateTime], powerDT[, Sub_metering_2], col="red")
lines(dt[, dateTime], powerDT[, Sub_metering_3],col="blue")
